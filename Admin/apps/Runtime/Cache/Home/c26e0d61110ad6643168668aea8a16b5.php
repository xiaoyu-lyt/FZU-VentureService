...
<!-- 分页 -->
	<div class="pull-right">
		<ul class="pagination">
			...
			<?php if(($curPage > 3) AND ($curPage < $totalPage-2)): $__FOR_START_13509__=$curPage-2;$__FOR_END_13509__=$curPage+3;for($i=$__FOR_START_13509__;$i < $__FOR_END_13509__;$i+=1){ ?><li><a <?php if($i==$curPage) echo "class='now'"; ?> href="/demo/jyzd/01/Admin/index.php/home/notice/<?php echo ($now); ?>/<?php echo ($i); ?>" ><?php echo ($i); ?></a></li><?php } ?>
			<?php elseif(($curPage > $totalPage-3) AND ($totalPage > 5)): ?>
				<?php $__FOR_START_11802__=$totalPage-5;$__FOR_END_11802__=$totalPage;for($i=$__FOR_START_11802__;$i < $__FOR_END_11802__;$i+=1){ ?><li><a <?php if($i==$curPage) echo "class='now'"; ?> href="/demo/jyzd/01/Admin/index.php/home/notice/<?php echo ($now); ?>/<?php echo ($i); ?>" ><?php echo ($i); ?></a></li><?php } ?>
			<?php elseif($totalPage > 5): ?>
				<?php $__FOR_START_15691__=1;$__FOR_END_15691__=6;for($i=$__FOR_START_15691__;$i < $__FOR_END_15691__;$i+=1){ ?><li><a <?php if($i==$curPage) echo "class='now'"; ?> href="/demo/jyzd/01/Admin/index.php/home/notice/<?php echo ($now); ?>/<?php echo ($i); ?>" ><?php echo ($i); ?></a></li><?php } ?>
			<?php else: ?>
				<?php $__FOR_START_9000__=1;$__FOR_END_9000__=$totalPage;for($i=$__FOR_START_9000__;$i < $__FOR_END_9000__;$i+=1){ ?><li><a <?php if($i==$curPage) echo "class='now'"; ?> href="/demo/jyzd/01/Admin/index.php/home/notice/<?php echo ($now); ?>/<?php echo ($i); ?>" ><?php echo ($i); ?></a></li><?php } endif; ?>

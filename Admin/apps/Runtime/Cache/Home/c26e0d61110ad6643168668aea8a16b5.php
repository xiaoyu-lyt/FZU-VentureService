...
<div class="user-box  admin-info-management sub-management pull-right">
	<div class="admin-top">
		...
		<a class="admin-publish-article" href="/FZU-VentureService/Admin/index.php/home/notice/publish">发布文章</a>
	</div>
		...
		<table>
			...
			<?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
					...
					<td class="admin-article-operation admin-operation">
						<span class="admin-article-modify"><a href="/FZU-VentureService/Admin/index.php/home/notice/modify?nid=<?php echo ($v["nid"]); ?>">修改</a></span>

...
<body>
			...
			<div class="signup-content">
				...
				<div class="signup-box">
					<div class="signup-form-student signup-form block">
						<form id="signup-form-student" class="signup-form-users" action="/FZU-VentureService/Admin/index.php/Home/home/login" method="post">
	...
	<script src="/FZU-VentureService/Admin/Public/js/verify.js"></script>
</body>
</html>
...
<div class="user-box admin-users-management sub-management pull-right">
	...
	<div class="pull-right">
		<ul class="pagination">
			...
			<?php if(($curPage > 3) AND ($curPage < $totalPage-2)): $__FOR_START_4209__=$curPage-2;$__FOR_END_4209__=$curPage+3;for($i=$__FOR_START_4209__;$i < $__FOR_END_4209__;$i+=1){ ?><li><a <?php if($i==$curPage) echo "class='now'"; ?> href="/demo/jyzd/Admin/index.php/home/user/<?php echo ($now); ?>/<?php echo ($i); ?>" ><?php echo ($i); ?></a></li><?php } ?>
			<?php elseif(($curPage > $totalPage-3) AND ($totalPage > 5)): ?>
				<?php $__FOR_START_7766__=$totalPage-5;$__FOR_END_7766__=$totalPage;for($i=$__FOR_START_7766__;$i < $__FOR_END_7766__;$i+=1){ ?><li><a <?php if($i==$curPage) echo "class='now'"; ?> href="/demo/jyzd/Admin/index.php/home/user/<?php echo ($now); ?>/<?php echo ($i); ?>" ><?php echo ($i); ?></a></li><?php } ?>
			<?php elseif($totalPage > 5): ?>
				<?php $__FOR_START_20183__=1;$__FOR_END_20183__=6;for($i=$__FOR_START_20183__;$i < $__FOR_END_20183__;$i+=1){ ?><li><a <?php if($i==$curPage) echo "class='now'"; ?> href="/demo/jyzd/Admin/index.php/home/user/<?php echo ($now); ?>/<?php echo ($i); ?>" ><?php echo ($i); ?></a></li><?php } ?>
			<?php else: ?>
				<?php $__FOR_START_17348__=1;$__FOR_END_17348__=$totalPage;for($i=$__FOR_START_17348__;$i < $__FOR_END_17348__;$i+=1){ ?><li><a <?php if($i==$curPage) echo "class='now'"; ?> href="/demo/jyzd/Admin/index.php/home/user/<?php echo ($now); ?>/<?php echo ($i); ?>" ><?php echo ($i); ?></a></li><?php } endif; ?>

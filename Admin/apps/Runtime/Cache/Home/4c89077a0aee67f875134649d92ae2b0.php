...
<div class="user-box admin-games-management pull-right">
	<div class="admin-top">
		<a class="admin-publish-game" href="/demo/jyzd/Admin/index.php/home/competition/publish">发布比赛通知</a>
	</div>
		...
		<?php else: ?>
			<?php if(is_array($competition)): $i = 0; $__LIST__ = $competition;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
					...
					<td class="admin-article-operation admin-operation">
						<span class="admin-article-modify"><a href="/demo/jyzd/Admin/index.php/home/competition/modify?nid=<?php echo ($v["cid"]); ?>">修改</a></span>
	...
	<div id="list" class="pull_right">
		<ul class="pagination">
			<li><a href="/demo/jyzd/Admin/index.php/home/competition/index/1">首页</a></li>
			<li><a href="/demo/jyzd/Admin/index.php/home/competition/index/<?php echo ($curPage-1); ?>">上一页</a></li>
			<?php $__FOR_START_1664__=1;$__FOR_END_1664__=$totalPage;for($i=$__FOR_START_1664__;$i < $__FOR_END_1664__;$i+=1){ ?><li><a href="/demo/jyzd/Admin/index.php/home/competition/index/<?php echo ($i); ?>"><?php echo ($i); ?></a></li><?php } ?>
			<li><a href="/demo/jyzd/Admin/index.php/home/competition/index/<?php echo ($curPage+1); ?>">下一页</a></li>
			<li><a href="/demo/jyzd/Admin/index.php/home/competition/index/<?php echo ($totalPage-1); ?>">末页</a></li>

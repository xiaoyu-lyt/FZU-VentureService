...
<div class="user-box block">
	<form class="publish-form form-horizontal" action="/demo/jyzd/01/Admin/index.php/home/class/modify/<?php echo ($class["cid"]); ?>/do" method="post">
		<h2 align="center" style="margin: 0 0 20px 0; color: #61a3e1;">培训课堂发布修改</h2>
	 	<table class="publish-table">
			...
			<tr>
				...
				<td>
					<textarea name="content" rows="20" cols="70"><?php echo ($class["content"]); ?></textarea>
				</td>
			</tr>
			<tr>

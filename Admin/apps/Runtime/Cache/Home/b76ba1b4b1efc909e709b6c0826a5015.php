...
<div class="user-box block">
	<form class="publish-form form-horizontal" action="/demo/jyzd/01/Admin/index.php/home/class/publish/do" method="post">
		<h2 align="center" style="margin: 0 0 20px 0; color: #61a3e1;">培训课堂发布</h2>
	 	<table class="publish-table">
			...
			<tr>
				...
				<td><input name="teacher" style="width:140px;" class="title-input form-control" type="text"></td>
			</tr>
			<tr>
				<td><h4 class="line-title text-right"><span class="star">*</span>主办方：</h4></td>
				<td><input name="sponsor" style="width:140px;" class="title-input form-control" type="text"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input name="limit" style="width:140px;" class="title-input form-control" type="number"></td>
			</tr>
			<tr>

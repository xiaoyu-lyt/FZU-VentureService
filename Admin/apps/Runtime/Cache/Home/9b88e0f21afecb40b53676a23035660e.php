...
<!-- 教师信息 -->
<div class="admin-teachers-box admin-users-table admin-table block" id="teachers-info-table">
	<table>
		<tr>
		...
		<?php else: ?>
			<?php if(is_array($teachers)): $i = 0; $__LIST__ = $teachers;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
					...
					<td class="admin-investor-operation admin-operation">
						...
						<a onclick="javascript: if(confirm('确定删除？')) return true; return false;" href="/demo/jyzd/01/Admin/index.php/home/user/delete?uid=<?php echo ($v["uid"]); ?>&module=teacher"><span class="admin-view-info">删除</span></a>
					</td>
	...
	<div class="pull-right">
		<ul class="pagination">
			...
			<?php if(($curPage > 3) AND ($curPage < $totalPage-2)): $__FOR_START_19556__=$curPage-2;$__FOR_END_19556__=$curPage+3;for($i=$__FOR_START_19556__;$i < $__FOR_END_19556__;$i+=1){ ?><li><a <?php if($i==$curPage) echo "class='now'"; ?> href="/demo/jyzd/01/Admin/index.php/home/user/<?php echo ($now); ?>/<?php echo ($i); ?>" ><?php echo ($i); ?></a></li><?php } ?>
			<?php elseif(($curPage > $totalPage-3) AND ($totalPage > 5)): ?>
				<?php $__FOR_START_11981__=$totalPage-5;$__FOR_END_11981__=$totalPage;for($i=$__FOR_START_11981__;$i < $__FOR_END_11981__;$i+=1){ ?><li><a <?php if($i==$curPage) echo "class='now'"; ?> href="/demo/jyzd/01/Admin/index.php/home/user/<?php echo ($now); ?>/<?php echo ($i); ?>" ><?php echo ($i); ?></a></li><?php } ?>
			<?php elseif($totalPage > 5): ?>
				<?php $__FOR_START_4994__=1;$__FOR_END_4994__=6;for($i=$__FOR_START_4994__;$i < $__FOR_END_4994__;$i+=1){ ?><li><a <?php if($i==$curPage) echo "class='now'"; ?> href="/demo/jyzd/01/Admin/index.php/home/user/<?php echo ($now); ?>/<?php echo ($i); ?>" ><?php echo ($i); ?></a></li><?php } ?>
			<?php else: ?>
				<?php $__FOR_START_6803__=1;$__FOR_END_6803__=$totalPage;for($i=$__FOR_START_6803__;$i < $__FOR_END_6803__;$i+=1){ ?><li><a <?php if($i==$curPage) echo "class='now'"; ?> href="/demo/jyzd/01/Admin/index.php/home/user/<?php echo ($now); ?>/<?php echo ($i); ?>" ><?php echo ($i); ?></a></li><?php } endif; ?>

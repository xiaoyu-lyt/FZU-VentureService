		...
		<?php else: ?>
			<?php if(is_array($policy)): $i = 0; $__LIST__ = $policy;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
					<td class="admin-article-select">
						<input id="<?php echo ($v["nid"]); ?>" class="admin-policy-select-btn admin-select-btn" type="checkbox">
					</td>
...
<!-- 分页 -->
	<div class="pull-right">
		<ul class="pagination">
			...
			<?php if(($curPage > 3) AND ($curPage < $totalPage-2)): $__FOR_START_341453362__=$curPage-2;$__FOR_END_341453362__=$curPage+3;for($i=$__FOR_START_341453362__;$i < $__FOR_END_341453362__;$i+=1){ ?><li><a <?php if($i==$curPage) echo "class='now'"; ?> href="/FZU-VentureService/Admin/index.php/home/notice/<?php echo ($now); ?>/<?php echo ($i); ?>" ><?php echo ($i); ?></a></li><?php } ?>
			<?php elseif(($curPage > $totalPage-3) AND ($totalPage > 5)): ?>
				<?php $__FOR_START_1511778977__=$totalPage-5;$__FOR_END_1511778977__=$totalPage;for($i=$__FOR_START_1511778977__;$i < $__FOR_END_1511778977__;$i+=1){ ?><li><a <?php if($i==$curPage) echo "class='now'"; ?> href="/FZU-VentureService/Admin/index.php/home/notice/<?php echo ($now); ?>/<?php echo ($i); ?>" ><?php echo ($i); ?></a></li><?php } ?>
			<?php elseif($totalPage > 5): ?>
				<?php $__FOR_START_650203599__=1;$__FOR_END_650203599__=6;for($i=$__FOR_START_650203599__;$i < $__FOR_END_650203599__;$i+=1){ ?><li><a <?php if($i==$curPage) echo "class='now'"; ?> href="/FZU-VentureService/Admin/index.php/home/notice/<?php echo ($now); ?>/<?php echo ($i); ?>" ><?php echo ($i); ?></a></li><?php } ?>
			<?php else: ?>
				<?php $__FOR_START_1236698286__=1;$__FOR_END_1236698286__=$totalPage;for($i=$__FOR_START_1236698286__;$i < $__FOR_END_1236698286__;$i+=1){ ?><li><a <?php if($i==$curPage) echo "class='now'"; ?> href="/FZU-VentureService/Admin/index.php/home/notice/<?php echo ($now); ?>/<?php echo ($i); ?>" ><?php echo ($i); ?></a></li><?php } endif; ?>

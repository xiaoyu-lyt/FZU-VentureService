...
<!-- 分页 -->
	<div class="pull-right">
		<ul class="pagination">
			...
			<?php if(($curPage > 3) AND ($curPage < $totalPage-2)): $__FOR_START_22135__=$curPage-2;$__FOR_END_22135__=$curPage+3;for($i=$__FOR_START_22135__;$i < $__FOR_END_22135__;$i+=1){ ?><li><a <?php if($i==$curPage) echo "class='now'"; ?> href="/demo/jyzd/Admin/index.php/home/notice/<?php echo ($now); ?>/<?php echo ($i); ?>" ><?php echo ($i); ?></a></li><?php } ?>
			<?php elseif(($curPage > $totalPage-3) AND ($totalPage > 5)): ?>
				<?php $__FOR_START_17124__=$totalPage-5;$__FOR_END_17124__=$totalPage;for($i=$__FOR_START_17124__;$i < $__FOR_END_17124__;$i+=1){ ?><li><a <?php if($i==$curPage) echo "class='now'"; ?> href="/demo/jyzd/Admin/index.php/home/notice/<?php echo ($now); ?>/<?php echo ($i); ?>" ><?php echo ($i); ?></a></li><?php } ?>
			<?php elseif($totalPage > 5): ?>
				<?php $__FOR_START_9037__=1;$__FOR_END_9037__=6;for($i=$__FOR_START_9037__;$i < $__FOR_END_9037__;$i+=1){ ?><li><a <?php if($i==$curPage) echo "class='now'"; ?> href="/demo/jyzd/Admin/index.php/home/notice/<?php echo ($now); ?>/<?php echo ($i); ?>" ><?php echo ($i); ?></a></li><?php } ?>
			<?php else: ?>
				<?php $__FOR_START_11778__=1;$__FOR_END_11778__=$totalPage;for($i=$__FOR_START_11778__;$i < $__FOR_END_11778__;$i+=1){ ?><li><a <?php if($i==$curPage) echo "class='now'"; ?> href="/demo/jyzd/Admin/index.php/home/notice/<?php echo ($now); ?>/<?php echo ($i); ?>" ><?php echo ($i); ?></a></li><?php } endif; ?>
